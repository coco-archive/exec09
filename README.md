...
* __multicomp09__ - see miscsbc.c for details

* __smii__ - see miscsbc.c for details

* __kipper1__ - see miscsbc.c for details
...
- The __auto table__. The variables in this table are pre-defined.
